---
id: java-server-sdk/getting-started/app-java
sdk: java-server-sdk
kind: hello-world
lang: java
file: src/main/java/com/launchdarkly/tutorial/App.java
description: Hello-world program that initializes the Java server SDK and watches a feature flag.
inputs:
  apiKey:
    type: sdk-key
    description: SDK key baked into the rendered source. Validation reads LAUNCHDARKLY_SDK_KEY at runtime; the env var takes precedence.
  featureKey:
    type: flag-key
...
Remove the prepopulated lines except the first line and add the following code to `App.java`:
...
import java.io.IOException;
  ...
  public class App {
    ...
    static String SDK_KEY = "{{ apiKey }}";

    // Set FEATURE_FLAG_KEY to the feature flag key you want to evaluate.
    static String FEATURE_FLAG_KEY = "{{ featureKey }}";

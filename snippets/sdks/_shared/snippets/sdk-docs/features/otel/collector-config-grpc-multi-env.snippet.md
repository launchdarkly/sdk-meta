---
id: sdk-docs/features/otel/collector-config-grpc-multi-env
kind: reference
lang: yaml
description: OpenTelemetry collector configuration sending traces to LaunchDarkly over gRPC (multiple environments).

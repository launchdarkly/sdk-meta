---
id: sdk-docs/features/otel/collector-config-http-single-env
kind: reference
lang: yaml
description: OpenTelemetry collector configuration sending traces to LaunchDarkly over HTTP (one environment).

---
id: python-server-sdk/ai-configs-agents/langchain-openai-full-example
sdk: python-server-sdk
kind: full-example
lang: python
file: python-server-sdk/ai-configs-agents/langchain-openai/full-example.txt
description: End-to-end LangChain + OpenAI agent wired through a LaunchDarkly AI Config agent_config(). Mirrors the "Show full example code" sample in the AI Configs agent quickstart.
---

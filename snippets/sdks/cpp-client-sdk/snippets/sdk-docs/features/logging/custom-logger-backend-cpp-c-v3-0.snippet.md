---
id: cpp-client-sdk/sdk-docs/features/logging/custom-logger-backend-cpp-c-v3-0
sdk: cpp-client-sdk
kind: reference
lang: c
description: Custom log backend callback definitions example for C++ (client-side) SDK v3.0 (C binding).
validation:

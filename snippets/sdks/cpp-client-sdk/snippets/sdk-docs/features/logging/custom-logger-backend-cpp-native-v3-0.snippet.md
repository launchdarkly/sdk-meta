---
id: cpp-client-sdk/sdk-docs/features/logging/custom-logger-backend-cpp-native-v3-0
sdk: cpp-client-sdk
kind: reference
lang: cpp
description: Custom log backend implementation example for C++ (client-side) SDK v3.0 (native).
validation:

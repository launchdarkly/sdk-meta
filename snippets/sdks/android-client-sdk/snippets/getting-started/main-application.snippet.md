---
id: android-client-sdk/getting-started/main-application
sdk: android-client-sdk
kind: hello-world
lang: kotlin
file: app/src/main/java/com/launchdarkly/hello_android/MainApplication.kt
description: Application subclass that initializes the LDClient on app start.
inputs:
  mobileKey:
    type: mobile-key
...
class MainApplication : Application() {
    ...
    companion object {
        ...
        const val LAUNCHDARKLY_MOBILE_KEY = "{{ mobileKey }}"
    }

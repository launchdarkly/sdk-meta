---
id: cpp-server-sdk/sdk-docs/features/relay-proxy-config/proxy-mode/proxy-mode-c-sdk-v2
sdk: cpp-server-sdk
kind: reference
lang: c
description: Proxy mode configuration example for the v2.x C server SDK.
validation:

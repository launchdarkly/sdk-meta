---
id: js-client-sdk/sdk-docs/features/qualfeedback/feedback-widget-ts
sdk: js-client-sdk
kind: reference
lang: typescript
description: Example React feedback widget component in TypeScript.
validation:
...
export function FeedbackPopover({
  ...
  const [sentiment, setSentiment] = useState<LDFeedbackSentiment | undefined>(
    undefined
  );

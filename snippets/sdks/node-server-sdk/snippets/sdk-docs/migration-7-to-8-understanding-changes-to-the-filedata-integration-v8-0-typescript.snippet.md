---
id: node-server-sdk/sdk-docs/migration-7-to-8-understanding-changes-to-the-filedata-integration-v8-0-typescript
sdk: node-server-sdk
kind: reference
lang: typescript
description: "v8.0+ (TypeScript) in section \"Understanding changes to the FileData integration\""
---

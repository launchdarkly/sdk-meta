// Loads the locally-served React app in headless Chromium, polls the
// page text for the EXAM-HELLO success line, and exits 0 when matched.
const { chromium } = require('/harness/node_modules/playwright');

(async () => {
  const url = process.env.REACT_PREVIEW_URL || 'http://localhost:4173';
